...
<div class="container">
    ...
    <a href="/articles/create" class="btn btn-dark mt-2 ">Create Article</a>
                        ...
                        <th>Delete</th>
                            ...
                            @foreach ($articles as $article)
                              <tr>
                                ...
                                <th > <a href="/articles/{{$article->id}}/edit" class="btn btn-light">Edit</a></th>

                                <th>
                                    {!!Form::open(['action'=> ['AdminArticleController@destroy', $article->id],'method' => 'POST', 'class' => 'pull-right' ])!!}
